...
const expectedActive = ["a", "abbr", "address", "blockquote", "button", "caption", "cite", "code", "dd", "dl", "dt", "em", "fieldset", "figcaption", "figure", "h1", "h2", "h3", "h4", "h5", "h6", "hr", "img", "input", "input-button", "input-email", "input-number", "input-password", "input-reset", "input-search", "input-submit", "input-tel", "input-text", "input-url", "kbd", "label", "legend", "li", "mark", "ol", "output", "p", "pre", "select", "small", "strong", "table", "td", "textarea", "th", "ul"];
