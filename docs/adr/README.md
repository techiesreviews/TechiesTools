...
- [0001 — Attached Main Menu and Framework sidebar](./0001-attached-main-menu-and-framework-sidebar.md) — accepted.
- [0002 — CoreFramework style variable export](./0002-coreframework-style-variable-export.md) — superseded by ADR 0009.
- [0003 — Framework controls use shared accordion sections](./0003-framework-controls-use-shared-accordion-sections.md) — superseded by ADR 0010.
- [0004 — Framework guides Generative UI](./0004-framework-guides-generative-ui.md) — accepted.
- [0005 — Generation is prescriptive by default](./0005-generation-is-prescriptive-by-default.md) — accepted.
