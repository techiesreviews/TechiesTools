...
- Catalog-joined Markdown Guidance and intent modules covering the complete version-one inventory: Actions, Typography, Forms, Lists, Structure `address`, intrinsic Data table/cell treatments, and image/figure Media treatments now have reviewed Active Treatments; remaining entries are explicitly Native.
...
- Multiple saved Frameworks.
- Accounts, cloud sync, and collaboration.
- Automatic mutation from AI sessions.
- Inline Element Guidance editing.
- Broader Semantic Role taxonomy without demonstrated component needs.
