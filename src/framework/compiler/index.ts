...
export const compileFramework = (input: CompileFrameworkInput): FrameworkCompilation => {
  ...
  const contextArtifact = textArtifact("context.md", "text/markdown;charset=utf-8", contentHash, ["tokens.css", "elements.css"], serializeContext(input, activeElements, tokensArtifact.value, elementsArtifact.value, frameworkVersion, contentHash));
