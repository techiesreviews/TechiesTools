...
treatment: "Keep native option semantics; style with Framework tokens without removing browser fallback behavior."
use: ["Use clear concise label and value."]
avoid: "Put arbitrary interactive content inside."
version: "0.0.0"
baseline: { status: "widely-available", source: "mdn", sourceUrl: "https://developer.mozilla.org/en-US/docs/Web/HTML/Reference/Elements/option", checkedAt: "2026-07-16" }
deprecated: false
order: 630
