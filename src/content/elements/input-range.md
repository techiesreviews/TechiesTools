...
treatment: "Draft a semantic accent color through the browser-owned range widget. Keep appearance, track, thumb, dimensions, keyboard increments, high-contrast adaptation, and focus behavior native. Exclude this Treatment from portable export while accent-color remains Limited availability."
