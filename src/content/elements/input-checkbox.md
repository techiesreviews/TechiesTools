...
treatment: "Draft a semantic accent color through the browser-owned checkbox widget. Keep appearance, dimensions, checkmark, indeterminate state, disabled state, high-contrast adaptation, and focus behavior native. Exclude this Treatment from portable export while accent-color remains Limited availability."
